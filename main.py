...
parser.add_argument('service', choices=['imgur', 's3'], help='Service to use to upload images')
...
def upload_image(client, file, filename):
    global transfer
    ...
    if not args.no_upload:
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            for i, img in enumerate(imgs):
                ...
                img.save(filename)
                uploaded = upload_image(client, filename, 'MapperinoTool_' + str(i) + '_' + image_name)
